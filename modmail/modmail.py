...
class Modmail(commands.Cog):
    ...
    async def create_user_thread(self, member, initial_message, created_at):
    ...
    async def get_user_thread(self, member):
